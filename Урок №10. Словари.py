...
while name != '':
    pets[name] = {'Вид питомца': input("Вид питомца: "),'Возраст питомца': int(input("Возраст питомца: ")), 'Имя владельца': input("Имя владельца: ")}
    name = input("Введите кличку следующего питомца(если нет, оставьте строчку пусто):")
for k,v in pets.items():
    if (2<= v['Возраст питомца']%10 <=4) and not(11<= v['Возраст питомца']%100 <=14): 
        age = str(v['Возраст питомца']) + ' года '
    elif v['Возраст питомца'] % 10 == 1 and v['Возраст питомца']%100 != 11: 
        age = str(v['Возраст питомца']) + ' год '
    else:
        age = str(v['Возраст питомца']) + ' лет '
    print(f"Это {v['Вид питомца']} по кличке '{k}'. Возраст питомца: {age}. Имя владельца: {v['Имя владельца']}")   
