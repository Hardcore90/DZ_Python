...
# Создание рандомных матриц и их сложение

def createMatrix(n, m):
    randomMatrix = [[randint(-100,101) for i in range(m)] for j in range(n)]
    return randomMatrix

print("Создаем матрицу A с рандомным заполнением: ")
row1 = int(input("Введите количество строк: "))
col1 = int(input("Введите количество столбцов: "))
randomMatrix_1 = createMatrix(row1, col1)
printMatrix(randomMatrix_1)
print("Создаем матрицу B с рандомным заполнением: ")
row2 = int(input("Введите количество строк: "))
col2 = int(input("Введите количество столбцов: "))
randomMatrix_2 = createMatrix(row2, col2)
printMatrix(randomMatrix_1)

if row1 == row2 and col1 == col2:
    print("Результат сложения матрицы A и B: ")
    sumMatrix = []
    for i in range(row1):
        res = []
        for j in range(col1):        
            sum = randomMatrix_1[i][j] + randomMatrix_2[i][j]
            res.append(sum)
        sumMatrix.append(res) 
    printMatrix(sumMatrix)
else:
    print("Размеры двух матриц не совпадают! Сложение матриц не возможно!")